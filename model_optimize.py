...
# 过滤反应时长超过8小时的
# data_time = data_time.loc[data_time['A20_interval']<8]
# data_time = data_time.loc[data_time['A28_interval']<8]
# data_time = data_time.loc[data_time['B4_interval']<8]

# data_time['B9_B10_B11_interval'] = data_time['B11_end'] - data_time['B9_start'] 
# data_time.loc[data_time['B9_B10_B11_interval']<0, 'B9_B10_B11_interval'] = \
#             data_time.loc[data_time['B9_B10_B11_interval']<0, 'B9_B10_B11_interval'] + 24
# data_time = data_time.loc[data_time['B9_B10_B11_interval']<8]
# data_time.drop(columns='B9_B10_B11_interval', inplace=True)
...
if not os.path.exists('./pipeline_data/optimize_data.csv'):
    
    data_pipeline = data_time.loc[[train.shape[0]]].copy()
    ...
    #                         'B11_start', 'B11_interval', 'B11_end', 
                           ...
                           'B12', 'B13', 
                           'B14']
    data_pipeline = data_pipeline[keys]
    data_pipeline.to_csv('./pipeline_data/optimize_data.csv', index=False)
...
sub_df = pd.read_csv(TEST_PATH)[['样本id']]
